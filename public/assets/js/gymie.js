var gymie = (function ($) {
	...
	return {
      ...
      var bar = new Morris.Bar({
        element: "gymie-user-registrations",
        data: JSON.parse(jsRegistraionsCount),
        xkey: "month", // here is the months values
        ykeys: ["registrations", "totalincom"], // here is the actual key values
        labels: ["Total Members", "Total Monthly Income"],
        fillOpacity: 0.6,
        hideHover: "auto",
        behaveLikeLine: true,
        resize: true,
