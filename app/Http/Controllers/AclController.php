...
class AclController extends Controller
{
    ...
    public function userIndex()
    {
        ...
        return view('user.userIndex', compact('users', 'count'));
    }
    ...
    public function updateUser($id, Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            $file = $request->file('photo');
                $file->move(public_path(). '/media/staff',$file->getClientOriginalName());
    
                 $user_image = $file->getClientOriginalName();
                 $user_detail->update(['image' => $user_image]);
    ...
    public function roleIndex()
    {
        ...
        return view('user.roleIndex', compact('roles', 'count'));
    }
