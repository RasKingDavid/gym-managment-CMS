                ...
                <div class="col-md-12">
                    <div class="panel no-border">
                        <div class="panel-title">
                            <div class="panel-head font-size-20 pull-left"><h4>Upgrade/downgrade ({{$subscription->member->name  }}) subscription </h4></div>
                            <a href="{{ URL::previous() }}" class="btn btn-sm active btn-primary pull-right"> back</a>
                        </div>
