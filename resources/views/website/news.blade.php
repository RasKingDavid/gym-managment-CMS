...
@section('content')
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="{{ asset('website/img/header-bg/3.jpg') }}">
		<div class="container">
			<h2>Blog</h2>
		</div>
	</section>
				...
				<div class="col-lg-8">
					<div class="blog-item">
						...
						<div class="blog-metas">
							<div class="blog-meta"><img src="{{ asset('website/img/icons/edit.png') }}" alt=""> By Admin</div>
							<div class="blog-meta"><img src="{{ asset('website/img/icons/layout.png') }}" alt="">in Workout</div>
							<div class="blog-meta"><img src="{{ asset('webssite/img/icons/profile.png') }}" alt="">2 comments</div>
						</div>
					...
					<div class="blog-item">
						<img src="{{ asset('webssite/img/blog/2.jpg') }}" alt="">
						<h2>Do you want strong arms? Here’s our tips</h2>
						<div class="blog-metas">
							<div class="blog-meta"><img src="{{ asset('website/img/icons/edit.png') }}" alt=""> By Admin</div>
							<div class="blog-meta"><img src="{{ asset('website/img/icons/layout.png') }}" alt="">in Workout</div>
							<div class="blog-meta"><img src="{{ asset('website/img/icons/profile.png') }}" alt="">2 comments</div>
						</div>
						<p>Donec nec sapien in urna fermentum ornare. Morbi vel ultrices leo. Sed eu turpis eu arcu vehicula fringilla ut vitae orci. Donec eget efficitur ex. Donec eget dolor vitae eros feugiat tristique id vitae massa. Proin vulputate congue rutrum. Fusce lobortis a enim eget tempus.</p>
						<div class="site-btn">Read More</div>
					</div>
					<div class="blog-item">
						<img src="{{ asset('website/img/blog/3.jpg') }}" alt="">
				...
				<div class="col-lg-4 col-md-7 col-sm-9 sidebar">
					<div class="widget-area">
						<form class="search-widget">
							...
							<button><img src="{{ asset('website/img/icons/search.png') }}" alt=""></button>
						</form>
					</div>
					<div class="widget-area">
					...
					<div class="widget-area">
						...
						<div class="recent-post-widget">
							<div class="rp-item">
								<img src="{{ asset('website/img/blog/blog-widget/1.jpg') }}" alt="">
								<div class="rp-text">
							...
							<div class="rp-item">
								<img src="{{ asset('website/img/blog/blog-widget/2.jpg') }}" alt="">
								<div class="rp-text">
							...
							<div class="rp-item">
								<img src="{{ asset('website/img/blog/blog-widget/3.jpg') }}" alt="">
								<div class="rp-text">
