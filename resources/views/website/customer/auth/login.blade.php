...
<div class="wrapper animated fadeInLeft">
    <div class="panel overflow-hidden">
        ...
        <form method="post" action="{{ route('customer.login-attempt') }}" enctype="multipart/form-data">
            ...
            <div class="box-body padding-md">
                ...
                <div class="form-group margin-top-20">
                    <a href="{{ route('customer.register') }}"><u>Create an account</u></a> / <a href="#"><u>Forgot Password?</u></a>
                </div>
