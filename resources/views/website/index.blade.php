...
<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="{{ asset('website/img/hero-bg.jpg') }}">
		<div class="container">
			<div class="hero-text">
	...
	<!-- Add section -->
	<section class="add-section set-bg" data-setbg="{{ asset('website/img/add-bg.jpg') }}">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 ml-auto">
					<div class="add-text">
						...
						<ul>
							<li><img src="{{ asset('website/img/check-icon.png') }}" alt="">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
							<li><img src="{{ asset('website/img/check-icon.png') }}" alt="">Risus commodo viverra maecenas accumsan lacus vel facilisis.</li>
							<li><img src="{{ asset('website/img/check-icon.png') }}" alt="">Ipsum dolor sit amet, consectetur adipiscing elit, sed do.</li>
						</ul>
						<a href="{{ url('classes') }}" class="site-btn">Become a Member</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						<div class="trainer-pic">
							<img src="{{ asset('website/img/trainers/1.jpg') }}" alt="">
						</div>
						<h4>Michael Smith</h4>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						<div class="trainer-pic">
							<img src="{{ asset('website/img/trainers/2.jpg') }}" alt="">
						</div>
						<h4>Jessica Black</h4>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						<div class="trainer-pic">
							<img src="{{ asset('website/img/trainers/3.jpg') }}" alt="">
						</div>
						<h4>James Brown</h4>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						<div class="trainer-pic">
							<img src="{{ asset('website/img/trainers/4.jpg') }}" alt="">
						</div>
						<h4>Paula Carlton</h4>
	...
	<section class="bmi-section spad">
		<div class="bmi-bg set-bg" data-setbg="{{ asset('website/img/bmi-bg.jpg') }}"></div>
		<div class="container">
			<div class="row">
				<div class="col-lg-7 ml-auto">
