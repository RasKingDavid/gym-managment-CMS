                        ...
                        <div class="panel-body">
                            <div class="border-bottom-1 border-grey-100 padding-bottom-30  clearfix">
                                ...
                                @if($settings['invoice_name_type'] == 'gym_logo')
                                    <img class="no-margin display-inline-block pull-left" src="{{asset('/media/company_image/'.$settings['gym_logo']) }}" width="100" height="100" alt="Gym-logo">
                                @else
                            ...
                            @if ($i > 1)
                                <h3 class="text-center"> {{ $settings['gym_name']  }} Invoice Copy </h3>
                            @endif
