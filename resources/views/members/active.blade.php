    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Active Members
                <small>All active members of {{ $settings['gym_name'] }}</small>
            </h1>
                            ...
                            @else
                                <table id="members" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($members as $member)
                                        ...
                                        ?>
                                        <tr>
                                            <td><a href="{{ action('MembersController@show',['id' => $member->id]) }}"><img src="{{ asset('media/member/' .$member->memberDetail->image) }}" width="50" height="50" / ></a></td>
