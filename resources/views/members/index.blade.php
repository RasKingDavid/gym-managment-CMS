...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height"><i class="fa fa-users"></i> Members
                ...
                <small>All members of {{ $settings['gym_name'] }}</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInRight total-count pull-right"><span class="label label-success" data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-10 font-size-14">Total Members</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                            ...
                            @else
                                <table id="members" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($members as $member)
                                        ...
                                        ?>
                                        <tr>
                                            <td><a href="{{ action('MembersController@show',['id' => $member->id]) }}"><img src="{{ asset('media/member/' .$member->memberDetail->image) }}" height="50" width="50"/></a></td>
