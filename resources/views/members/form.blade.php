...
<div class="row">
    ...
    @if(isset($member))
        ...
        <div class="col-sm-2">
            <img alt="proof Pic" class="pull-right" src="{{ asset('media/member/' .$member->memberDetail->proof_image) }}"/  height="70" width="70">
        </div>
    @else
        <div class="col-sm-6">
            <div class="form-group">
...
<div class="row">
    @if(isset($member))
        ...
        <div class="col-sm-2">
            <img alt="profile Pic" class="pull-right" src="{{ asset('media/member/' .$member->memberDetail->image) }}"/ height="70" width="70">
        </div>
    @else
        <div class="col-sm-6">
            <div class="form-group">
