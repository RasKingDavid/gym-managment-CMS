                        ...
                        <div class="panel-body">
                            <div class="row">                <!--Main row start-->
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <img class="AutoFitResponsive" src="{{ asset('media/member/' .$member->memberDetail->image) }}" height="180" width="200"/>
                                        </div>
                                            ...
                                            <div class="panel bg-grey-50">
                                                ...
                                                <div class="panel-body bg-white">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info">{{implode(",",$plansArray)}}</span>
                                                        </div>
                                                    </div>
                                                    <hr class="margin-top-0 margin-bottom-10">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info">{{Utilities::getStatusValue ($member->status)}}</span>
                                                        </div>
                                                    </div>
                                                    <hr class="margin-top-0 margin-bottom-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info">{{Utilities::getAim ($member->aim)}}</span>
                                                        </div>
                                                    </div>
                                                    <hr class="margin-top-0 margin-bottom-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info">{{$member->proof_name}}</span>
                                                        </div>
                                                    </div>
                                                    <hr class="margin-top-0 margin-bottom-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info ">{{$member->address}}</span>
                                                        </div>
                                                    </div>
                                                    <hr class="margin-top-0 margin-bottom-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <span class="show-data badge badge-info">{{$member->health_issues}}</span>
                                                        </div>
                                                    </div>
                                ...
                                @permission(['manage-gymie','manage-members','delete-member'])
                                        <button class="btn btn-danger pull-right" style="margin-right: 15px" data-toggle="modal" data-target="#deleteModal-{{$member->id}}" data-id="{{$member->id}}">
                                            <span>Delete</span>
                                        </button>
                                        @endpermission
