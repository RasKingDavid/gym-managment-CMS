                                    ...
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- Modal -->
                                                <div id="deleteModal-{{$event->id}}" class="modal  inmodal" role="dialog">
                                                <div class="modal-dialog">
                                                    <!-- Modal content-->
                                                    <div class="modal-content animated bounceInRight">
                                                        <div class="modal-header " style="background: rgb(202, 22, 22); color:#fff">
                                                            <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                                                            <h4 class="modal-title text-left">Confirm</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="" style="text-align: center !important">
                                                            <img src="{{ asset('media/icons/delete.gif') }}" alt="" width="200" height="150">
                                                            </div>
                                                            <p class="text-center">Are you sure you want to delete this event of {{ $event->name }} ? </p><br>
                                                        </div>
